...
Последняя проверка: **2026-08-21 14:40:14 UTC**
Текущая цена ETHUSDT: **2380.5**
...
Таймфрейм=15min, num_std=2.0, ADX-фильтр=True, RSI-подтверждение=True, стоп=1.0x ширины полосы, таймаут=20 баров, комиссия=0.1%/сторону. Только LONG (спот без плеча шорт не поддерживает).
