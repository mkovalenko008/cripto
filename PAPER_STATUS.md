...
Последняя проверка: **2026-08-29 15:31:25 UTC**

## Портфель

| Стартовый капитал | Текущий баланс | Результат | Сделок всего |
|---|---|---|---|
| 300.00 USDT | 298.9819 USDT | -0.34% | 45 |

## По монетам

| Монета | Результат | Сделок | Позиция |
|---|---|---|---|
| PEPEUSDT | +1.83% | 2 | LONG @ 0.000004 |
| MORPHOUSDT | +0.43% | 3 | — |
| ONDOUSDT | +0.41% | 1 | — |
| WLFIUSDT | +0.31% | 4 | — |
| AAVEUSDT | +0.13% | 1 | LONG @ 123.560000 |
| XRPUSDT | +0.00% | 0 | — |
| SOLUSDT | +0.00% | 0 | — |
| DOGEUSDT | +0.00% | 0 | — |
| ZECUSDT | +0.00% | 0 | — |
...
| DOTUSDT | +0.00% | 0 | — |
| ETHUSDT | -0.06% | 2 | — |
| SHIBUSDT | -0.08% | 2 | LONG @ 0.000005 |
| BNBUSDT | -0.36% | 1 | — |
| NEARUSDT | -0.38% | 3 | — |
| UNIUSDT | -0.47% | 2 | — |
| SKYUSDT | -0.59% | 1 | — |
| LTCUSDT | -0.71% | 4 | LONG @ 49.060000 |
| ADAUSDT | -0.87% | 1 | — |
| BTCUSDT | -0.91% | 3 | — |
| ASTERUSDT | -1.13% | 3 | — |
| XLMUSDT | -1.37% | 3 | — |
