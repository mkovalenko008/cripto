...
Последняя проверка: **2026-08-26 11:38:49 UTC**

## Портфель

| Стартовый капитал | Текущий баланс | Результат | Сделок всего |
|---|---|---|---|
| 300.00 USDT | 299.0383 USDT | -0.32% | 38 |
...
| AAVEUSDT | +0.13% | 1 | — |
| WLFIUSDT | +0.07% | 3 | — |
| BNBUSDT | +0.00% | 0 | LONG @ 705.000000 |
| XRPUSDT | +0.00% | 0 | — |
| SOLUSDT | +0.00% | 0 | — |
| DOGEUSDT | +0.00% | 0 | — |
| ZECUSDT | +0.00% | 0 | — |
...
| TAOUSDT | +0.00% | 0 | — |
| DOTUSDT | +0.00% | 0 | — |
| ETHUSDT | -0.04% | 1 | LONG @ 2461.410000 |
| SHIBUSDT | -0.08% | 2 | — |
| UNIUSDT | -0.47% | 2 | — |
| ASTERUSDT | -0.50% | 1 | — |
| NEARUSDT | -0.57% | 2 | — |
| SKYUSDT | -0.59% | 1 | — |
| LTCUSDT | -0.73% | 3 | LONG @ 50.540000 |
| ADAUSDT | -0.87% | 1 | — |
| BTCUSDT | -0.91% | 3 | — |
| XLMUSDT | -1.37% | 3 | — |
| PUMPUSDT | -1.39% | 2 | — |
