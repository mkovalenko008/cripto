...
Последняя проверка: **2026-09-12 01:05:02 UTC**

## Портфель

| Стартовый капитал | Текущий баланс | Результат | Сделок всего |
|---|---|---|---|
| 300.00 USDT | 297.1518 USDT | -0.95% | 85 |

## По монетам

| Монета | Результат | Сделок | Позиция |
|---|---|---|---|
| GRASSUSDT | +5.03% | 1 | LONG @ 0.324900 |
| METUSDT | +4.31% | 1 | — |
| SKYUSDT | +2.77% | 1 | — |
| ETHUSDT | +2.69% | 2 | — |
| ZAMAUSDT | +2.27% | 2 | — |
