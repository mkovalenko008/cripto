...
def main():
    ...
    data = {
        ...
        "bots": {
            "trend": {
                "label": "Трендовый бот",
                "subtitle": (f"Пробой полосы Боллинджера + ADX + трейлинг-стоп по ATR · "
                             f"{len(trend_state)} монет · 1H"),
                "accent": "trend",
                "version": "v1",
                "validated": True,
                "method_note": (
                    ...
                    "параметров. Корзина расширена до топ-100 монет Coinbase с USDT-парой на Bitget; "
                    "капитал разложен поровну, каждая монета торгуется независимо, лимит — не "
                    "больше 5% депозита на монету. Фактический депозит — сумма долей всех монет."
                ),
            ...
            "meanrev": {
                ...
                "method_note": (
                    ...
                    "Coinbase, пересечённый с наличием на Bitget Spot, расширен до 100 монет. Депозит "
                    "разложен поровну между ними, не больше 5% на монету."
                ),
