    ...
    data = {
        ...
        "bots": {
            ...
            "meanrev": {
                ...
                "validated": False,
                "method_note": (
                    "Первая протестированная стратегия сессии. Проверялась и на корзине из 23 монет "
                    "тоже — устойчивого плюса после комиссии не нашлось нигде, поэтому живьём торгует "
                    "только ETH, расширять на другие монеты незачем. Бот оставлен работать для "
                    "сравнения с трендовым, а не как рекомендация. Депозит тот же условный 300 USDT, что "
                    "у трендового; в каждую сделку заходит не больше 5% от текущего баланса счёта, "
                    "остальное — резерв, не задействованный в позиции."
                ),
