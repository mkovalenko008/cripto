        ...
        "bots": {
            ...
            "meanrev": {
                ...
                "method_note": (
                    ...
                    "сравнения с трендовым, а не как рекомендация. Депозит тот же условный 300 USDT и то "
                    "же правило 5% на монету, что у трендового — но монета тут одна, поэтому активный "
                    "капитал бота = 15 USDT (5% от 300), а не все 300."
                ),
